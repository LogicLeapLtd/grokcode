...
/// In-app publishing for Codessa's *own* plugin marketplace. The user fills in
...
struct PublishPluginSheet: View {
        ...
        HStack(spacing: 11) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text(publishedEntry == nil
                     ? "Add your plugin to the Codessa marketplace."
    ...
    private func successPanel(_ entry: MarketplaceEntry) -> some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Want it in the public marketplace? Copy the manifest entry and open a pull request on the Codessa marketplace repo.")
                .font(.system(size: 13))
                .foregroundStyle(CodexTheme.textSecondary)
