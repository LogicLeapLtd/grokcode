...
/// Static configuration for the Codessa license gate.
///
...
enum LicenseConfig {
    ...
    /// The hosted Lemon Squeezy checkout URL for the Codessa product/variant,
    ...
    // Set 2026-06-14: Codessa variant cba78c61-9924-4036-b512-34fec10f373f,
    ...
    // Intentionally 0: the grokcode store sells only Codessa, so any valid store
    // key IS a Codessa key. Set the numeric variant id here if you add more products.
