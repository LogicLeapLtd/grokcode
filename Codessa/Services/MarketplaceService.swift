...
/// Loads and persists Codessa's *own* community plugin marketplace.
///
...
final class MarketplaceService: @unchecked Sendable {
    ...
    /// `~/Library/Application Support/Codessa`. Created on demand.
    private var supportDirectory: URL {
        let base = FileManager.default.urls(for: .applicationSupportDirectory,
                                            in: .userDomainMask).first
            ?? FileManager.default.homeDirectoryForCurrentUser
                .appendingPathComponent("Library/Application Support")
        let dir = base.appendingPathComponent("Codessa", isDirectory: true)
