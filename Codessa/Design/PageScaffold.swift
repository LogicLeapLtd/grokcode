    ...
    var body: some View {
        Group {
            if scrolls {
                ...
                .background(PageScrollViewConfigurator())
            } else {
                column
            }
        }
        .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .top)
        // No opaque fill — the translucent dark base in MainContentView shows
        // through so Liquid Glass chrome on the page refracts properly.
    }
}
...
private struct PageScrollViewConfigurator: NSViewRepresentable {
